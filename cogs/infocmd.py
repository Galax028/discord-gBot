...
class info(commands.Cog):
    ...
    async def updatelog(self, ctx):
        ...
        page4 = discord.Embed(title='gBot Update Log - 2.0.0 to 2.0.1',
                              description="Version 2.0.0 - 2.0.1:\n- Leveling system\n- level command\n- readjson command\n- Minor UI fixes\n\n`Page 3 out of 4`")
        page5 = discord.Embed(title='gBott Update Log - 3.0.0 to 3.x.x',
                              description="Version 3.0.0 - 3.x.x:\n- Music system\n- join command\n- play command\n- pause command\n- resume command\n- skip commmand\n- clearqueue command\n- stop command\n- disconnect command\n\n`Page 4 out of 4`")
    ...
    async def gbothelp(self, ctx):
        ...
        page5 = discord.Embed(title='Level Commands',
                              ...
                              colour=discord.Colour.blurple())
        page6 = discord.Embed(title='Music Commands',
        ...
        page7 = discord.Embed(title='Special Commands',
